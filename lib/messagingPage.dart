...
class messagingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var pics = ["assets/images/myPic.jpg","assets/images/AWAIS.jpg","assets/images/Hamza.jpg","assets/images/Huzaifa.jpg","assets/images/Kaif.jpg","assets/images/Moeez.jpg","assets/images/Noman.jpg","assets/images/Shees.jpg","assets/images/Sikandar.jpg","assets/images/Sufyan.jpg","assets/images/Umair.jpg","assets/images/Wasique.jpg","assets/images/Zahid.jpg"];
    var names= ["Your note","Awais","Hamza","Huzaifa","Kaif","Moeez","Noman","Shees","Sikandar","Sufyan","Umair","Wasique","Zahid"];
    var note= ["+","✌️","🖤","😏","😎","🥀","✨","💝","☠️","🕊️","🔥","😁","💕"];

    var pics2 = ["assets/images/AWAIS.jpg","assets/images/Hamza.jpg","assets/images/Huzaifa.jpg","assets/images/Kaif.jpg","assets/images/Moeez.jpg","assets/images/Noman.jpg","assets/images/Shees.jpg","assets/images/Sikandar.jpg","assets/images/Sufyan.jpg","assets/images/Umair.jpg","assets/images/Wasique.jpg","assets/images/Zahid.jpg"];
    var names2= ["Muhammad Awais","Rana Hamza","Muhammad Huzaifa","Muhammad Kaif","Moeez Ul Hassan","Muhammad Noman","Muhammad Shees","Muhammad Bin Sikandar","Sufyan Rafiq","Umair Ahmad","Wasique Asjid","Zahid Ali"];
                            ...
                            Padding(
                              ...
                              child: TextButton(onPressed: (){
                                _showAlertDialog(context,'This option will be available soon.');
                                  ...
                                  child: const Text("itx._.mali",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24,color: Colors.white),)
                              ),
                            ),
                            Padding(
